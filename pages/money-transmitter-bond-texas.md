---
title: "Texas Money Transmitter Bond"
layout: "layout.njk"
---

<style>
.is-mttx *, .is-mttx *::before, .is-mttx *::after { box-sizing: border-box; }
.is-mttx {
  font-family: inherit;
  color: #0f172a;
...
.is-mttx .is-inner { max-width: 1000px; margin: 0 auto; padding: 0 24px; }

.is-mttx .is-hero-wrap {
  background: linear-gradient(135deg, #0c1e3d 0%, #2563eb 55%, #38bdf8 100%);
  padding: 72px 0 64px;
  position: relative;
  overflow: hidden;
}
.is-mttx .is-hero-wrap::before {
  content: "";
  position: absolute;
...
.is-mttx .is-toc-title { font-size: 11px; font-weight: 800; letter-spacing: 0.08em; text-transform: uppercase; color: #93c5fd; margin-bottom: 16px; }
.is-mttx .is-toc-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px 24px; }
.is-mttx .is-toc-grid a { font-size: 14px; color: #e2e8f0; text-decoration: none; font-weight: 500; display: flex; align-items: center; gap: 8px; }
.is-mttx .is-toc-grid a::before { content: "→"; color: #38bdf8; }
.is-mttx .is-toc-grid a:hover { color: #93c5fd; }

.is-mttx .is-sec { background: #fff; padding: 64px 0; }
.is-mttx .is-sec + .is-sec { border-top: 1px solid #f1f5f9; }
.is-mttx .is-sec h2 { font-size: clamp(22px, 2.8vw, 30px) !important; font-weight: 900 !important; color: #0f172a !important; margin: 0 0 16px !important; letter-spacing: -0.01em; }
...
.is-mttx .is-step:last-child { border-bottom: none; }
.is-mttx .is-step-num { width: 64px; height: 64px; background: linear-gradient(135deg, #2563eb, #38bdf8); border-radius: 18px; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 26px; font-weight: 900; flex-shrink: 0; box-shadow: 0 8px 20px rgba(37,99,235,0.35); }
.is-mttx .is-step h3 { font-size: 18px !important; font-weight: 800 !important; color: #0f172a !important; margin: 0 0 6px !important; }
.is-mttx .is-step p { font-size: 14.5px; color: #475569; margin: 0; line-height: 1.65; }

.is-mttx .is-why-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 14px; margin: 20px 0; }
.is-mttx .is-why-pill { background: #fff; border: 2px solid #e2e8f0; border-radius: 14px; padding: 20px; display: flex; align-items: center; gap: 14px; transition: all 0.2s; }
.is-mttx .is-why-pill:hover { border-color: #38bdf8; transform: translateY(-2px); box-shadow: 0 8px 20px rgba(56,189,248,0.15); }
.is-mttx .is-why-icon { width: 40px; height: 40px; border-radius: 10px; background: #eff6ff; color: #2563eb; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 18px; font-weight: 800; }
.is-mttx .is-why-pill span { font-size: 14px; color: #1e293b; font-weight: 600; }

.is-mttx .is-faq-list { display: flex; flex-direction: column; gap: 10px; margin: 20px 0; }
.is-mttx .is-faq-item { border: 1px solid #e2e8f0; border-radius: 14px; background: #fff; overflow: hidden; }
.is-mttx .is-faq-item[open] { border-color: #93c5fd; box-shadow: 0 6px 20px rgba(37,99,235,0.1); }
.is-mttx .is-faq-item summary { font-size: 15px; font-weight: 700; color: #0f172a; padding: 18px 22px; cursor: pointer; display: flex; justify-content: space-between; align-items: center; list-style: none; gap: 14px; }
.is-mttx .is-faq-item summary::-webkit-details-marker { display: none; }
.is-mttx .is-faq-item summary::after { content: "+"; font-size: 22px; font-weight: 300; color: #2563eb; flex-shrink: 0; transition: transform 0.25s; line-height: 1; }
.is-mttx .is-faq-item[open] summary::after { transform: rotate(45deg); }
.is-mttx .is-faq-body { padding: 0 22px 20px; }
.is-mttx .is-faq-body p { font-size: 14.5px; color: #475569; margin: 0; line-height: 1.7; }

.is-mttx .is-testimonials { display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin: 24px 0; }
.is-mttx .is-testimonial { background: #fff; border-radius: 16px; padding: 24px 22px; position: relative; box-shadow: 0 4px 16px rgba(0,0,0,0.05); border-top: 3px solid #2563eb; }
.is-mttx .is-testimonial::before { content: '"'; position: absolute; top: 8px; right: 20px; font-size: 48px; color: #eff6ff; font-family: Georgia, serif; line-height: 1; }
.is-mttx .is-testimonial-text { font-size: 14px; color: #334155; line-height: 1.65; font-style: italic; margin: 0 0 14px; position: relative; z-index: 1; }
.is-mttx .is-testimonial-name { font-weight: 700; color: #1e293b; font-size: 14px; display: block; }
.is-mttx .is-testimonial-role { font-size: 12px; color: #94a3b8; }

.is-mttx .is-hub-links { display: flex; flex-wrap: wrap; gap: 10px; margin: 20px 0 24px; }
.is-mttx .is-hub-links a { font-size: 13.5px; color: #1e40af; background: #eff6ff; border: 1px solid #bfdbfe; padding: 10px 18px; border-radius: 999px; text-decoration: none; font-weight: 600; transition: all 0.15s; }
.is-mttx .is-hub-links a:hover { background: #2563eb; color: #fff; border-color: #2563eb; }

.is-mttx .is-final-wrap { background: linear-gradient(135deg, #0c1e3d, #2563eb, #38bdf8); padding: 72px 0; text-align: center; position: relative; overflow: hidden; }
.is-mttx .is-final-wrap::before { content: ""; position: absolute; top: -80px; left: -80px; width: 320px; height: 320px; background: rgba(255,255,255,0.08); border-radius: 50%; }
.is-mttx .is-final-wrap::after { content: ""; position: absolute; bottom: -100px; right: -60px; width: 380px; height: 380px; background: rgba(255,255,255,0.05); border-radius: 50%; }
.is-mttx .is-final-wrap h2 { font-size: clamp(26px, 3.5vw, 40px) !important; color: #fff !important; margin: 0 0 14px !important; position: relative; z-index: 1; font-weight: 900 !important; }
.is-mttx .is-final-wrap p { font-size: 17px; color: rgba(255,255,255,0.9); margin: 0 auto 32px; max-width: 480px; position: relative; z-index: 1; }
.is-mttx .is-btn-white { display: inline-block; background: #fff; color: #2563eb !important; padding: 17px 40px; border-radius: 12px; font-size: 16px; font-weight: 800; text-decoration: none !important; position: relative; z-index: 1; transition: all 0.2s; box-shadow: 0 8px 24px rgba(0,0,0,0.2); }
.is-mttx .is-btn-white:hover { background: #eff6ff; transform: translateY(-3px); box-shadow: 0 12px 32px rgba(0,0,0,0.25); }
...
<div class="is-mttx">
  ...
  <div class="is-sec" id="what-is">
    <div class="is-inner">
      ...
      <h2>What Is a Texas Money Transmitter Bond?</h2>
      <p>A Texas Money Transmitter Bond is a state-required surety bond that protects consumers from financial loss caused by a money transmitter's failure to follow Texas laws. This bond applies to businesses that:</p>
      <div class="is-check-list">
        <div class="is-check-row"><div class="is-check-icon">✓</div><span>Transmit money or monetary value</span></div>
        <div class="is-check-row"><div class="is-check-icon">✓</div><span>Issue or sell payment instruments</span></div>
        <div class="is-check-row"><div class="is-check-icon">✓</div><span>Provide digital or electronic money transfer services</span></div>
        <div class="is-check-row"><div class="is-check-icon">✓</div><span>Operate as a money services business (MSB)</span></div>
      </div>
      <p>The bond ensures compliance with the Texas Department of Banking.</p>
    </div>
  </div>
  ...
  <div class="is-sec" id="who-needs">
    <div class="is-inner">
      ...
      <h2>Who Needs a Texas Money Transmitter Bond?</h2>
      <p>Required for businesses that:</p>
      <div class="is-check-list">
        <div class="is-check-row"><div class="is-check-icon">✓</div><span>Send or receive money</span></div>
        <div class="is-check-row"><div class="is-check-icon">✓</div><span>Issue payment instruments</span></div>
        <div class="is-check-row"><div class="is-check-icon">✓</div><span>Provide digital wallet or stored-value services</span></div>
        <div class="is-check-row"><div class="is-check-icon">✓</div><span>Operate online or app-based money transfer platforms</span></div>
      </div>
    </div>
  </div>
  ...
  <div class="is-sec" id="requirements">
    <div class="is-inner">
      ...
      <h2>Texas Money Transmitter Requirements</h2>
      <p>Texas requires:</p>
      <div class="is-check-list">
        <div class="is-check-row"><div class="is-check-icon">✓</div><span>NMLS application</span></div>
        <div class="is-check-row"><div class="is-check-icon">✓</div><span>Audited financial statements</span></div>
        ...
        <div class="is-check-row"><div class="is-check-icon">✓</div><span>Compliance with Texas Department of Banking rules</span></div>
      </div>
    </div>
  </div>
  ...
  <div class="is-sec" id="license">
    <div class="is-inner">
      ...
      <h2>Texas Money Transmitter License</h2>
      ...
      <div class="is-check-list">
        ...
        <div class="is-check-row"><div class="is-check-icon">✓</div><span>Provide compliance documentation</span></div>
  ...
  <div class="is-sec" id="process">
    <div class="is-inner">
      ...
      <div class="is-steps">
        <div class="is-step"><div class="is-step-num">1</div><div><h3>Complete the Application</h3><p>Submit the quick, 60-second application. Fast Texas approval — your bond is issued to meet all Texas Department of Banking requirements.</p></div></div>
  ...
  <div class="is-sec" id="faq">
    <div class="is-inner">
      ...
      <div class="is-faq-list">
        <details class="is-faq-item"><summary>How much does a money transmitter bond cost?</summary><div class="is-faq-body"><p>Most qualified applicants pay 1%–5% of the bond amount annually, with pricing based on bond amount, credit score, financial strength, and business experience. Texas bond amounts typically range from $300,000 to $2,000,000 based on business volume.</p></div></details>
        ...
        <details class="is-faq-item"><summary>What does the bond guarantee?</summary><div class="is-faq-body"><p>The bond guarantees compliance with Texas Department of Banking regulations and protects consumers from financial loss caused by a money transmitter's failure to follow Texas laws.</p></div></details>
        <details class="is-faq-item"><summary>Can the bond be refunded?</summary><div class="is-faq-body"><p>Refund policies vary by surety. Contact us for specifics on your Texas money transmitter bond.</p></div></details>
  ...
  <div class="is-final-wrap">
    <div class="is-inner">
      ...
      <a href="https://fc16062.propeller.insure/axelerator-public/#do=show+widget+page&State_search_scheme_property=Texas&State_search_scheme_property=Federal&name=public+home&one_search_search=money+transmitter" class="is-btn-white">Start My Application</a>
    </div>
  </div>

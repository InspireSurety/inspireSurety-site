...
/* ---- HERO: DARK SLATE-PLUM + LAVENDER (grounded, gravitas) ---- */
.is-pb .is-hero-wrap {
...
.is-pb .is-hero-tag { font-size: 17px; color: #d8b4fe; font-weight: 700; margin-bottom: 20px; position: relative; z-index: 1; }
.is-pb .is-hero-wrap p { font-size: 16px; color: rgba(255,255,255,0.88); line-height: 1.7; max-width: 600px; margin: 0 0 28px; position: relative; z-index: 1; }
...
.is-pb .is-hero-note { font-size: 13px; color: rgba(255,255,255,0.6); margin-top: 14px; position: relative; z-index: 1; }
...
.is-pb .is-hero-stat-label { font-size: 11px; color: rgba(255,255,255,0.65); font-weight: 600; margin-top: 4px; display: block; }
...
.is-pb .is-toc-title { font-size: 11px; font-weight: 800; letter-spacing: 0.08em; text-transform: uppercase; color: #d8b4fe; margin-bottom: 16px; }
...
.is-pb .is-toc-grid a::before { content: "→"; color: #9333ea; }
.is-pb .is-toc-grid a:hover { color: #d8b4fe; }
...
.is-pb .is-eyebrow { display: inline-block; font-size: 11px; font-weight: 800; letter-spacing: 0.1em; text-transform: uppercase; color: #6b21a8; margin-bottom: 10px; }
...
.is-pb .is-check-icon { width: 26px; height: 26px; border-radius: 50%; background: #faf5ff; color: #6b21a8; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 12px; font-weight: 800; }
...
.is-pb .is-stat-cell-big { background: linear-gradient(135deg, #44337a, #9333ea); color: #fff; }
.is-pb .is-stat-num { font-size: 30px; font-weight: 900; color: #44337a; line-height: 1; }
...
.is-pb .is-step-num { width: 64px; height: 64px; background: linear-gradient(135deg, #44337a, #9333ea); border-radius: 18px; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 26px; font-weight: 900; flex-shrink: 0; box-shadow: 0 8px 20px rgba(68,51,122,0.35); }
...
.is-pb .is-tile { background: #fff; border: 1px solid #e2e8f0; border-top: 3px solid #44337a; border-radius: 12px; padding: 22px 20px; transition: all 0.2s; }
.is-pb .is-tile:hover { transform: translateY(-3px); box-shadow: 0 12px 28px rgba(0,0,0,0.08); border-top-color: #9333ea; }
...
.is-pb .is-why-pill:hover { border-color: #9333ea; transform: translateY(-2px); box-shadow: 0 8px 20px rgba(147,51,234,0.12); }
.is-pb .is-why-icon { width: 40px; height: 40px; border-radius: 10px; background: #faf5ff; color: #6b21a8; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 18px; font-weight: 800; }
...
.is-pb .is-faq-item[open] { border-color: #d8b4fe; box-shadow: 0 6px 20px rgba(147,51,234,0.1); }
...
.is-pb .is-faq-item summary::after { content: "+"; font-size: 22px; font-weight: 300; color: #6b21a8; flex-shrink: 0; transition: transform 0.25s; line-height: 1; }
...
/* ---- FINAL CTA ---- */
.is-pb .is-final-wrap { background: linear-gradient(135deg, #1e1b2e, #44337a, #9333ea); padding: 72px 0; text-align: center; position: relative; overflow: hidden; }
...
.is-pb .is-final-wrap p { font-size: 17px; color: rgba(255,255,255,0.88); margin: 0 auto 32px; max-width: 480px; position: relative; z-index: 1; }
.is-pb .is-btn-white { display: inline-block; background: #fff; color: #44337a !important; padding: 17px 40px; border-radius: 12px; font-size: 16px; font-weight: 800; text-decoration: none !important; position: relative; z-index: 1; transition: all 0.2s; box-shadow: 0 8px 24px rgba(0,0,0,0.2); }

...
/* ---- HERO: DEEP PURPLE (Court & Fiduciary category) ---- */
.is-pb .is-hero-wrap {
...
.is-pb .is-hero-tag { font-size: 17px; color: #ddd6fe; font-weight: 700; margin-bottom: 20px; position: relative; z-index: 1; }
.is-pb .is-hero-wrap p { font-size: 16px; color: rgba(255,255,255,0.9); line-height: 1.7; max-width: 600px; margin: 0 0 28px; position: relative; z-index: 1; }
...
.is-pb .is-hero-note { font-size: 13px; color: rgba(255,255,255,0.65); margin-top: 14px; position: relative; z-index: 1; }
.is-pb .is-hero-stats { display: flex; gap: 32px; margin-top: 36px; padding-top: 28px; border-top: 1px solid rgba(255,255,255,0.2); position: relative; z-index: 1; flex-wrap: wrap; }
.is-pb .is-hero-stat-num { font-size: 26px; font-weight: 900; color: #fff; line-height: 1; display: block; }
.is-pb .is-hero-stat-label { font-size: 11px; color: rgba(255,255,255,0.7); font-weight: 600; margin-top: 4px; display: block; }

/* ---- TOC ---- */
.is-pb .is-toc {
  background: #1e0a3f; border-radius: 20px; padding: 32px 36px;
  margin: -36px auto 0; max-width: 940px; position: relative; z-index: 2;
  box-shadow: 0 20px 50px rgba(0,0,0,0.25);
}
.is-pb .is-toc-title { font-size: 11px; font-weight: 800; letter-spacing: 0.08em; text-transform: uppercase; color: #c4b5fd; margin-bottom: 16px; }
...
.is-pb .is-toc-grid a::before { content: "→"; color: #8b5cf6; }
.is-pb .is-toc-grid a:hover { color: #c4b5fd; }
...
.is-pb .is-eyebrow { display: inline-block; font-size: 11px; font-weight: 800; letter-spacing: 0.1em; text-transform: uppercase; color: #6d28d9; margin-bottom: 10px; }
...
.is-pb .is-check-icon { width: 26px; height: 26px; border-radius: 50%; background: #f5f3ff; color: #6d28d9; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 12px; font-weight: 800; }
...
.is-pb .is-stat-cell-big { background: linear-gradient(135deg, #6d28d9, #8b5cf6); color: #fff; }
.is-pb .is-stat-num { font-size: 30px; font-weight: 900; color: #6d28d9; line-height: 1; }
...
.is-pb .is-stat-cell-big .is-stat-label { color: rgba(255,255,255,0.85); }
...
.is-pb .is-step-num { width: 64px; height: 64px; background: linear-gradient(135deg, #6d28d9, #8b5cf6); border-radius: 18px; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 26px; font-weight: 900; flex-shrink: 0; box-shadow: 0 8px 20px rgba(109,40,217,0.3); }
...
.is-pb .is-tile { background: #fff; border: 1px solid #e2e8f0; border-top: 3px solid #6d28d9; border-radius: 12px; padding: 22px 20px; transition: all 0.2s; }
.is-pb .is-tile:hover { transform: translateY(-3px); box-shadow: 0 12px 28px rgba(0,0,0,0.08); border-top-color: #a855f7; }
.is-pb .is-tile-icon { width: 40px; height: 40px; border-radius: 10px; background: #f5f3ff; display: flex; align-items: center; justify-content: center; font-size: 19px; margin-bottom: 14px; }
...
.is-pb .is-why-pill:hover { border-color: #6d28d9; transform: translateY(-2px); box-shadow: 0 8px 20px rgba(109,40,217,0.1); }
.is-pb .is-why-icon { width: 40px; height: 40px; border-radius: 10px; background: #f5f3ff; color: #6d28d9; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 18px; font-weight: 800; }
...
.is-pb .is-faq-item[open] { border-color: #c4b5fd; box-shadow: 0 6px 20px rgba(109,40,217,0.1); }
...
.is-pb .is-faq-item summary::after { content: "+"; font-size: 22px; font-weight: 300; color: #6d28d9; flex-shrink: 0; transition: transform 0.25s; line-height: 1; }
...
/* ---- FINAL CTA ---- */
.is-pb .is-final-wrap { background: linear-gradient(135deg, #2e1065, #4c1d95, #6d28d9); padding: 72px 0; text-align: center; position: relative; overflow: hidden; }
.is-pb .is-final-wrap::before { content: ""; position: absolute; top: -80px; left: -80px; width: 320px; height: 320px; background: rgba(255,255,255,0.06); border-radius: 50%; }
.is-pb .is-final-wrap::after { content: ""; position: absolute; bottom: -100px; right: -60px; width: 380px; height: 380px; background: rgba(255,255,255,0.04); border-radius: 50%; }
...
.is-pb .is-final-wrap p { font-size: 17px; color: rgba(255,255,255,0.9); margin: 0 auto 32px; max-width: 480px; position: relative; z-index: 1; }
.is-pb .is-btn-white { display: inline-block; background: #fff; color: #4c1d95 !important; padding: 17px 40px; border-radius: 12px; font-size: 16px; font-weight: 800; text-decoration: none !important; position: relative; z-index: 1; transition: all 0.2s; box-shadow: 0 8px 24px rgba(0,0,0,0.2); }
.is-pb .is-btn-white:hover { background: #f5f3ff; transform: translateY(-3px); box-shadow: 0 12px 32px rgba(0,0,0,0.25); }
  ...
  <div class="is-hero-wrap">
    <div class="is-inner">
      ...
      <a href="https://fc16062.propeller.insure/axelerator-public/#do=show+widget+page&name=public+home&one_search_search=probate" class="is-btn-primary">
        ...
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#4c1d95" stroke-width="2.5"><path d="M5 12h14M13 6l6 6-6 6"/></svg>
      </a>

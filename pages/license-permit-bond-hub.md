...
/* ---- GUIDE LIST: DARK CARDS WITH NUMBERED BADGES ---- */
.is-lp .is-guide-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px; margin: 20px 0; }
.is-lp .is-guide-card {
  background: #0f172a;
  border-radius: 12px;
  padding: 16px 18px;
...
.is-lp .is-guide-card:hover { transform: translateY(-2px); box-shadow: 0 10px 28px rgba(30,64,175,0.25); }
.is-lp .is-guide-num {
...
.is-lp .is-guide-card a { font-size: 13.5px; color: #e2e8f0; text-decoration: none; font-weight: 600; }
.is-lp .is-guide-card a:hover { color: #7dd3fc; }
...
@media (max-width: 720px) {
  ...
  .is-lp .is-guide-grid { grid-template-columns: 1fr; }

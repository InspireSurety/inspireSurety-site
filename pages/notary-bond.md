...
.is-not .is-hero-stat-label { font-size: 11px; color: rgba(255,255,255,0.6); font-weight: 600; margin-top: 4px; display: block; }

/* ---- HUB CALLOUT: FULL BLEED GREEN ---- */
.is-not .is-hub-wrap {
  background: #f0fdf4;
...
/* ---- WHITE SECTION ---- */
.is-not .is-sec-white { background: #fff; padding: 64px 0; }
/* ---- LIGHT GRAY SECTION ---- */
.is-not .is-sec-gray { background: #f8fafc; padding: 64px 0; }
/* ---- TINT BLUE SECTION ---- */
.is-not .is-sec-tint { background: linear-gradient(135deg, #eff6ff, #f0f9ff); padding: 64px 0; }
...
.is-not .is-toc-title { font-size: 11px; font-weight: 800; letter-spacing: 0.08em; text-transform: uppercase; color: #7dd3fc; margin-bottom: 16px; }
...
.is-not .is-toc-grid a::before { content: "→"; color: #60a5fa; }
.is-not .is-toc-grid a:hover { color: #7dd3fc; }
...
.is-not .is-stat-cell-big { background: linear-gradient(135deg, #2563eb, #1d4ed8); color: #fff; }
.is-not .is-stat-num { font-size: 30px; font-weight: 900; color: #1d4ed8; line-height: 1; }
...
.is-not .is-stat-cell-big .is-stat-label { color: rgba(255,255,255,0.8); }
...
/* ---- STATE CARDS: BOLD SPLIT ---- */
.is-not .is-state-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; margin: 24px 0; }
.is-not .is-state-card {
  background: #0f172a;
  border-radius: 18px;
  padding: 28px 26px;
  color: #fff;
}
.is-not .is-state-flag { font-size: 11px; font-weight: 800; letter-spacing: 0.08em; text-transform: uppercase; color: #7dd3fc; margin-bottom: 10px; }
...
.is-not .is-why-pill:hover { border-color: #2563eb; transform: translateY(-2px); box-shadow: 0 8px 20px rgba(37,99,235,0.1); }
...
.is-not .is-final-wrap::before { content: ""; position: absolute; top: -80px; left: -80px; width: 320px; height: 320px; background: rgba(255,255,255,0.06); border-radius: 50%; }
.is-not .is-final-wrap::after { content: ""; position: absolute; bottom: -100px; right: -60px; width: 380px; height: 380px; background: rgba(255,255,255,0.04); border-radius: 50%; }
...
.is-not .is-final-wrap p { font-size: 17px; color: rgba(255,255,255,0.85); margin: 0 auto 32px; max-width: 480px; position: relative; z-index: 1; }
.is-not .is-btn-white { display: inline-block; background: #fff; color: #1e40af !important; padding: 17px 40px; border-radius: 12px; font-size: 16px; font-weight: 800; text-decoration: none !important; position: relative; z-index: 1; transition: all 0.2s; box-shadow: 0 8px 24px rgba(0,0,0,0.2); }
...
@media (max-width: 720px) {
  ...
  .is-not .is-sec-white, .is-not .is-sec-gray, .is-not .is-sec-tint { padding: 44px 0; }
...
<div class="is-not">
  ...
  <div class="is-hero-wrap">
    <div class="is-inner">
      ...
      <a href="/pages/contact/" class="is-btn-primary">
        ...
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#1e40af" stroke-width="2.5"><path d="M5 12h14M13 6l6 6-6 6"/></svg>
      </a>
  ...
  <!-- TOC: FLOATING DARK CARD OVERLAPPING HERO -->
  <div class="is-toc">
  ...
  <!-- HUB CALLOUT: FULL BLEED GREEN STRIP -->
  <div class="is-hub-wrap">
    <div class="is-inner">
      <div class="is-hub-callout">
        💡 <span>Need help with a license or permit bond? Explore our <a href="/pages/license-permit-bond-hub/">License &amp; Permit Bond Hub</a> for state-specific requirements and application guides.</span>
      </div>
    </div>
  </div>

  <!-- WHAT IS A NOTARY BOND: WHITE -->
  ...
  <div class="is-sec-gray" id="cost">
    <div class="is-inner is-sec">
      ...
      <p style="font-weight:700;color:#1d4ed8;font-size:16px;">Apply once — your state lookup happens during the application.</p>
    </div>
  </div>

  <!-- WHO NEEDS THIS: WHITE -->
  ...
  <!-- STATE SPECIFIC: DARK CARDS ON GRAY -->
  ...
  <div class="is-sec-white">
    <div class="is-inner is-sec">
      ...
      <a href="/pages/surety-bond-learning-center/" style="color:#1d4ed8;font-weight:700;font-size:14.5px;text-decoration:none;">Surety Bond Learning Center →</a>
    </div>
  </div>

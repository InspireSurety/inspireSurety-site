...
/* ---- HERO: DARK STEEL-TEAL + CYAN (grounded, matches Probate depth pattern) ---- */
.is-not .is-hero-wrap {
  background: linear-gradient(135deg, #0c1e2a 0%, #0e5568 45%, #0891b2 100%);
  padding: 72px 0 64px;
  position: relative;
  overflow: hidden;
}
...
.is-not .is-hero-tag { font-size: 17px; color: #67e8f9; font-weight: 700; margin-bottom: 20px; position: relative; z-index: 1; }
.is-not .is-hero-wrap p { font-size: 16px; color: rgba(255,255,255,0.88); line-height: 1.7; max-width: 600px; margin: 0 0 28px; position: relative; z-index: 1; }
.is-not .is-btn-primary {
  display: inline-flex; align-items: center; gap: 8px;
  background: #fff; color: #0e5568 !important;
...
.is-not .is-hero-note { font-size: 13px; color: rgba(255,255,255,0.6); margin-top: 14px; position: relative; z-index: 1; }
...
.is-not .is-hero-stat-label { font-size: 11px; color: rgba(255,255,255,0.65); font-weight: 600; margin-top: 4px; display: block; }

/* ---- TOC ---- */
.is-not .is-toc {
  background: #08222b; border-radius: 20px; padding: 32px 36px;
  margin: -36px auto 0; max-width: 940px; position: relative; z-index: 2;
  box-shadow: 0 20px 50px rgba(0,0,0,0.25);
}
.is-not .is-toc-title { font-size: 11px; font-weight: 800; letter-spacing: 0.08em; text-transform: uppercase; color: #67e8f9; margin-bottom: 16px; }
...
.is-not .is-toc-grid a::before { content: "→"; color: #0891b2; }
.is-not .is-toc-grid a:hover { color: #67e8f9; }
...
.is-not .is-eyebrow { display: inline-block; font-size: 11px; font-weight: 800; letter-spacing: 0.1em; text-transform: uppercase; color: #0e7490; margin-bottom: 10px; }
...
.is-not .is-check-icon { width: 26px; height: 26px; border-radius: 50%; background: #ecfeff; color: #0e7490; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 12px; font-weight: 800; }
...
.is-not .is-stat-cell-big { background: linear-gradient(135deg, #0e5568, #0891b2); color: #fff; }
.is-not .is-stat-num { font-size: 30px; font-weight: 900; color: #0e5568; line-height: 1; }
...
.is-not .is-step-num { width: 64px; height: 64px; background: linear-gradient(135deg, #0e5568, #0891b2); border-radius: 18px; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 26px; font-weight: 900; flex-shrink: 0; box-shadow: 0 8px 20px rgba(14,85,104,0.35); }
...
.is-not .is-state-card { background: #08222b; border-radius: 18px; padding: 28px 26px; color: #fff; }
.is-not .is-state-flag { font-size: 11px; font-weight: 800; letter-spacing: 0.08em; text-transform: uppercase; color: #67e8f9; margin-bottom: 10px; }
...
.is-not .is-state-card a { font-size: 13.5px; color: #67e8f9; font-weight: 700; text-decoration: none; }
...
.is-not .is-why-pill:hover { border-color: #0891b2; transform: translateY(-2px); box-shadow: 0 8px 20px rgba(8,145,178,0.12); }
.is-not .is-why-icon { width: 40px; height: 40px; border-radius: 10px; background: #ecfeff; color: #0e7490; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 18px; font-weight: 800; }
...
.is-not .is-faq-item[open] { border-color: #67e8f9; box-shadow: 0 6px 20px rgba(8,145,178,0.1); }
...
.is-not .is-faq-item summary::after { content: "+"; font-size: 22px; font-weight: 300; color: #0e7490; flex-shrink: 0; transition: transform 0.25s; line-height: 1; }
...
.is-not .is-testimonial { background: #fff; border-radius: 16px; padding: 24px 22px; position: relative; box-shadow: 0 4px 16px rgba(0,0,0,0.05); border-top: 3px solid #0891b2; }
.is-not .is-testimonial::before { content: '"'; position: absolute; top: 8px; right: 20px; font-size: 48px; color: #ecfeff; font-family: Georgia, serif; line-height: 1; }
...
.is-not .is-hub-links a { font-size: 13.5px; color: #0e5568; background: #ecfeff; border: 1px solid #a5f3fc; padding: 10px 18px; border-radius: 999px; text-decoration: none; font-weight: 600; transition: all 0.15s; }
.is-not .is-hub-links a:hover { background: #0891b2; color: #fff; border-color: #0891b2; }

/* ---- FINAL CTA ---- */
.is-not .is-final-wrap { background: linear-gradient(135deg, #0c1e2a, #0e5568, #0891b2); padding: 72px 0; text-align: center; position: relative; overflow: hidden; }
...
.is-not .is-btn-white { display: inline-block; background: #fff; color: #0e5568 !important; padding: 17px 40px; border-radius: 12px; font-size: 16px; font-weight: 800; text-decoration: none !important; position: relative; z-index: 1; transition: all 0.2s; box-shadow: 0 8px 24px rgba(0,0,0,0.2); }
.is-not .is-btn-white:hover { background: #ecfeff; transform: translateY(-3px); box-shadow: 0 12px 32px rgba(0,0,0,0.25); }
...
<div class="is-not">
  ...
  <div class="is-hero-wrap">
    <div class="is-inner">
      ...
      <a href="https://fc16062.propeller.insure/axelerator-public/#do=show+widget+page&name=public+home&one_search_search=notary" class="is-btn-primary">
        ...
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#0e5568" stroke-width="2.5"><path d="M5 12h14M13 6l6 6-6 6"/></svg>
      </a>
  ...
  <div class="is-sec" id="cost">
    <div class="is-inner">
      ...
      <p style="font-weight:700;color:#0e5568;font-size:16px;">Apply once — your state lookup happens during the application.</p>
    </div>
  </div>
  ...
  <div class="is-sec">
    <div class="is-inner">
      ...
      <a href="/pages/surety-bond-learning-center/" style="color:#0e5568;font-weight:700;font-size:14.5px;text-decoration:none;">Surety Bond Learning Center →</a>
    </div>
  </div>
